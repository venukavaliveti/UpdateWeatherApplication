...
struct WeatherView: View {
    ...
    var body: some View {
        NavigationView {
            ZStack{
                ScrollView{
                    VStack{
                        Image("garden")
                            ...
                            .overlay {
                                VStack(alignment: .leading,spacing: 0){
                                    Text(LocalizedStringKey("OpenWeather"))
                                        .padding(.leading)
                                        .font(.headline)
                                        .foregroundColor(.red)
                                    Text(LocalizedStringKey("Weather forecasts, nowcasts and \n history in a fast and elegant way"))
                        ...
                        HStack {
                            TextField(LocalizedStringKey("Search City"), text:$viewModel.cityName,onCommit: {
            ...
            .navigationTitle(LocalizedStringKey("Weather App"))
        }
